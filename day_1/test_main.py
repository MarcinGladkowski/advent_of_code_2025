...
# def test_edge_cases():
#     assert run(['L1000'], count_all_dial_points) == 10
#     assert run(['R50'], count_all_dial_points) == 1
#     assert run(['R150'], count_all_dial_points) == 2
...
#     assert move_left(1, 1) == (0, 0)

# def test_right_move():
#     assert move_right(50, 68) == (18, 1)
#     assert move_right(52, 48) == (0, 0)
#     assert move_right(0, 1) == (1, 0)
#     assert move_right(99, 1) == (0, 0)
...
#     """
#     assert run(['L1000'], count_all_dial_points) == 10
#     assert run(['L1050'], count_all_dial_points) == 11
